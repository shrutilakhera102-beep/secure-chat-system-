...
function getToken()    { return localStorage.getItem('secureChatToken'); }
function getUsername() { return localStorage.getItem('secureChatUser'); }
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                localStorage.setItem('secureChatToken', data.token);
                localStorage.setItem('secureChatUser',  data.username || username);
